...
public class ListCustCounter extends javax.swing.JFrame {
    ...
    public ListCustCounter(int counterNumber) {
        ...
        CounterName.setText("Counter " + counterNumber);
    ...
    private void initComponents() {
        ...
        CounterName = new javax.swing.JLabel();
        ...
        CounterName.setBackground(new java.awt.Color(255, 255, 255));
        CounterName.setFont(new java.awt.Font("sansserif", 0, 22)); // NOI18N
        CounterName.setText("Counter 0");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(CounterName, javax.swing.GroupLayout.PREFERRED_SIZE, 102, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(21, 21, 21))
        );
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        if (payment == null) {
            ...
            switch (counterNumber) {
                case 1 -> datacust = (CustInformation) SelfCheckout.Main.getCounter1().peek();
                case 2 -> datacust = (CustInformation) SelfCheckout.Main.getCounter2().peek();
                case 3 -> datacust = (CustInformation) SelfCheckout.Main.getCounter3().peek();
                default -> {
                }
            }
            if (datacust == null) {
    ...
    //press the customer once and then press "open customer item" to open item list
    ...
    private javax.swing.JLabel CounterName;
